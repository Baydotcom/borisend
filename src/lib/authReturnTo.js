...
// RC20 Part 18 — validate an arbitrary internal route string (used by the
// deep-link login-preservation flow). Same security rules as safeReturnTo:
// same-origin only, single leading slash (no "//" prefix, no backslash),
// bootstrap/auth-token params stripped. Returns a safe internal path or "/".
export function validateInternalRoute(rawPath) {
